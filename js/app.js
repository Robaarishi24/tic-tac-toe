...
function checkWinner() {
    ...
    //check the 2 diameter possibilities
...
let stop = function () {
    for (let i = 0; i < squares.length; i++) {
        squares[i].removeEventListener("click",startGame);//remove the event
        }
}
